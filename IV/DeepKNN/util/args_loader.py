...
def get_args():
    ...
    parser.add_argument('--in-dataset', default="MNIST", type=str, help='CIFAR-10 imagenet')
    ...
    parser.add_argument('--model-arch', default='sinvad_CNN', type=str, help='model architecture')
