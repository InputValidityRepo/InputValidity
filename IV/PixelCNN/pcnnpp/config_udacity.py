...
# log and save config
print_every = 3  # how many iterations between print statements
evaluate_print_every = 3  # how many iterations between print statements in evalutation
save_interval = 3 # Every how many epochs to write checkpoint/samples?
plot_every = 3  # plot loss epochs interval
evaluate_every = 3  # evaluation interval
load_params = './pixelcnn/d0.1pcnnpplr0.00100resnet5filter160nrmix10/models/Udacity_d0.1pcnnpplr0.00100resnet5filter160nrmix10_5.pth'
start_epoch = 0

# data loader
batch_size = 6  # Batch size during training per GPU
...
max_epochs = 20  # How many epochs to run in total
...
data_dir = '/home/jzhang2297/anomaly/data/MNIST/'  # Location for the dataset
