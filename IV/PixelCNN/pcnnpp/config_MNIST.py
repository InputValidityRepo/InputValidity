...
# log and save config
print_every = 5  # how many iterations between print statements
evaluate_print_every = 5  # how many iterations between print statements in evalutation
save_interval = 5 # Every how many epochs to write checkpoint/samples?
plot_every = 5  # plot loss epochs interval
evaluate_every = 5  # evaluation interval
load_params = './pixelcnn/d0.1pcnnpplr0.00020resnet4filter60nrmix3/models/d0.1pcnnpplr0.00020resnet4filter60nrmix3_19.pth'  # Restore training from previous model checkpoint (specify the model dump file path)
