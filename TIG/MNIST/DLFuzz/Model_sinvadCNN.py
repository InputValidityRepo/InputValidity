...
def two_conv_pool(x, F1, F2, name):
        ...
        # (stride=(1,1), dilation=(1,1), out shape=(28,28)
        x = Activation('relu')(x)
...
def Model_sinvad(input_tensor=None, train=False):
    ...
    if train:
        # compiling
        sgd = keras.optimizers.Adam(lr=2e-4, epsilon=1e-08)
        ...
        # save model
        model.save_weights('./Model_adam_sinvad.h5')
        ...
        print('loading model sinvad weights')
        model.load_weights('./Model_adam_sinvad.h5')
